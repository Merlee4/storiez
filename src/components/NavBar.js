  ...
  return (
    <div className="p-4 flex items-center justify-between sm:border">
      ...
      <div className="flex gap-4 items-center justify-end">
        {/* NEW STORY BUTTON */}
        <button
          className="outline-none flex gap-2  px-3 py-2 text-white rounded bg-indigo-900 hover:bg-blue-800 transition duration-200 ease-in-out items-center"
          style={{ outline: "none" }}
        >
          <PlusIcon className="gap-5 h-5" />
          <p className="text-sm font-normal hidden sm:flex ">NEW STORY</p>
        </button>
        ...
        >
          ...
          <div className="flex items-center ">
            <img
              ...
              className="rounded-full h-full w-12 border border-indigo-900"
              alt="person"
            />
